...
<section class="content">
				...
				<div class="box-body">
					<table width="100%">
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<input type="text" id="user" value="<?= $this->fungsi->user_login()->name ?>"
							...
							<td>
								<div class="form-group">
									<select name="" id="customer" class="form-control">
										...
										<?php foreach ($customer as $cus => $data) {
							...
							<td>
								<div class="form-group input-group">
									...
									<span class="input-group-btn">
										<button class="btn btn-info btn-flat" type="button" dat-toggle="modal"
	...
	<div class="row">
		...
		<div class="col-lg-3">
			<div>
				<button id="cancel_payment" class="btn btn-warning btn-flat">
					<i class="fa fa-refresh"></i> Cancel
				</button><br><br>
				<button id="process_payment" class="btn btn-success btn-lg btn-flat">
